	...
	return (
		<div className="space-y-6">
			...
			<Card>
				<CardHeader>
					<CardTitle>
						Transacciones ({history.transactions?.length || 0})
					</CardTitle>
				</CardHeader>
				<CardContent>
					...
					history.transactions.length === 0 ? (
						<div className="flex flex-col items-center justify-center py-8">
							...
							<p className="text-sm text-slate-400 text-center">
								El historial de transacciones del token en la
								blockchain está vacío. Esto puede ocurrir si el
								token fue creado recientemente o si no hay
